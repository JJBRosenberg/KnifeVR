...
public class LightSaber : MonoBehaviour
{
    ...
    private bool isRumbling; // Flag to check if the controller is currently rumbling
    private float rumbleDuration = 3.0f;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.layer == 12)
        {
            ...
            //StartCoroutine(rumble(rumbleDuration));
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        {
            StopAllCoroutines();
            //PXR_Input.SendHapticImpulse(VibrateType.RightController, 0, 0, 0);
        }
        ...
        slices[0].gameObject.layer = 12;
        slices[1].gameObject.layer = 12;
